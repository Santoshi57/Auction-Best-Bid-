...
// console.log(productCount);
  return (
    <>{loading ? (<Loader/>) :(
    <>
    <MetaData title="Fotheby's"></MetaData>
          ...
          <div className='row'>
            <div className='col-10 mx-auto'>
              ...
              <div className='col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column' data-aos="fade-up" data-aos-delay="300">
                <h1> Bid and sell items with <strong className='brand-name'><br/>Fotheby's </strong></h1>

                <h2 className="my-3">
                  An Fotheby's is a service in which auction users or participants sell or bid for products or services via the Internet.
                </h2>
                <div className='mt-3'>
