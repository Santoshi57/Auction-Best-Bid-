				...
				<div className="col-md-12">
					<div className="wrapper">
						<div className="row mb-5" data-aos="fade-up" data-aos-delay="300">
			        		...
			        		<div className="text">
				            <p><span>Address:</span> Jorpati,Katmandu</p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
			        		...
			        		<div className="text">
				            <p><span>Phone:</span> <a href="tel://8980452333" >+977 980452333</a></p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
			        		...
			        		<div className="text">
				            <p><span>Email:</span> <a href="mailto:itznihal143@gmail.com">Kiran@gmail.com</a></p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
