                ...
                <div className="row abtclssection">
                  ...
                  <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div className="box">
                      ...
                      <h3>Mission</h3>
                      <p>Auctioning in physical form is somewhat challenging. People cannot market their products internationally.
                        You need to navigate to the auction site. A user with a solid internet connection may quickly sell their stuff using this app by bidding.
                  ...
                  <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                    <div className="box">
                      ...
                      <h3>Ease of Use</h3>
                      <p>Results may be simply generated through the website, eliminating the need for third-party interruption.Our technology verifies all of the vendors and bidders.
                      </p>
                    </div>
                  </div>
