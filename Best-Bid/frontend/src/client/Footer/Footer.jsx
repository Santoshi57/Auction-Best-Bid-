  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-lg-3 col-md-6 footer-contact">
        ...
        <p>
        Nami College<br/>
          Dashindhoka, Jorpati<br/>
          Kathmandu <br/><br/>
          <strong>Phone:</strong>+977 9876534231<br/>
          <strong>Email:</strong> kiran@gmail.com<br/>
        </p>
      </div>
...
<div className="container py-4">
  <div className="copyright">
    &copy; Copyright <strong><span>Fotheby's</span></strong>. All Rights Reserved
  </div>
